...
if sep == "RunAgent":
    out_filename = "agent_" + in_filename
elif sep == "Run":
    out_filename = "run_" + in_filename
else:
    out_filename = "none_" + in_filename
...
with open(in_filename, 'r') as read_obj, \
    ...
    header.append(sep + "surprise_lone")
    header.append(sep + "surprise_cond")
    header.append(sep + "surprise_cond2")
    header.append(sep + "blnkt_surprise_lone")
    header.append(sep + "blnkt_surprise_cond")
    header.append(sep + "blnkt_surprise_cond2")
    header.append(sep + "int_surprise_lone")
    header.append(sep + "int_surprise_cond")
    header.append(sep + "int_surprise_cond2")
